...
<?php echo $this->DisplayImage->displayControlThumbnail($saveTmpImageResult['banner_image']['tmp_file_name'], 2, 80, 300, true); ?>
<br>
...
<td>
<?php
echo h($this->Html->dateFormat($data['Banner']['published']['year'].'-'.$data['Banner']['published']['month'].'-'.$data['Banner']['published']['day']." 00:00:00"));
?>
</td>
</tr>
<tr>
...
<p>
<?php echo $this->Form->create('Banner', array('type' => 'file', 'action' => 'control_add')); ?>
<?php echo $this->Formhidden->hiddenVars(); ?>
<?php echo $this->Form->submit('入力画面に戻る', array('div' => false, 'id' => 'indexButton')); ?>
<?php echo $this->Form->end(); ?>
&nbsp;
<?php echo $this->Form->create('Banner', array('type' => 'file', 'action' => 'control_add_complete')); ?>
<?php echo $this->Formhidden->hiddenVars(); ?>
