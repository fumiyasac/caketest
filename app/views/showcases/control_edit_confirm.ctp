...
<th>公開日</th>
<td>
<?php echo h($this->Html->dateFormat($data['Showcase']['published']['year'].'-'.$data['Showcase']['published']['month'].'-'.$data['Showcase']['published']['day']." 00:00:00")); ?>
</td>
</tr>
<tr>
...
<p>
<?php echo $this->Form->create('Showcase', array('type' => 'file', 'action' => 'control_edit')); ?>
<?php echo $this->Formhidden->hiddenVars(); ?>
<?php echo $this->Form->submit('入力画面に戻る', array('div' => false, 'id' => 'indexButton')); ?>
<?php echo $this->Form->end(); ?>
&nbsp;
<?php echo $this->Form->create('Showcase', array('type' => 'file', 'action' => 'control_edit_complete')); ?>
<?php echo $this->Formhidden->hiddenVars(); ?>
