...
<header>
<h3>ここではアンケートの内容を編集することが出来ます。</h3>
</header>
<section>
<div class="adminContentsBody">
<p>アンケートの編集が完了しました。一覧ページより内容が正しいかを確認して下さい。</p>
...
<p>
<?php echo $this->Form->create('Post', array('type' => 'post', 'url' => 'index')); ?>
<?php echo $this->Form->submit('アンケートの一覧に戻る', array('div' => false, 'id' => 'indexButton')); ?>
