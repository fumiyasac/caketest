...
<header>
<h3>ここではスライドショーを追加することが出来ます。</h3>
</header>
<section>
<div class="adminContentsBody">
<p>スライドショーの追加が完了しました。一覧ページより内容が正しいかを確認して下さい。</p>
...
<p>
<?php echo $this->Form->create('Slide', array('type' => 'post', 'url' => 'index')); ?>
<?php echo $this->Form->submit('スライドショー画像の一覧に戻る', array('div' => false, 'id' => 'indexButton')); ?>
