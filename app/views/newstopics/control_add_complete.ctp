...
<p>ニュース&amp;トピックを投稿が完了しました。一覧ページより内容が正しいかを確認して下さい。</p>
...
<p>
<?php echo $this->Form->create('Newstopic', array('type' => 'post', 'url' => 'index')); ?>
<?php echo $this->Form->submit('ニュース&トピックの一覧に戻る', array('div' => false, 'id' => 'indexButton')); ?>
