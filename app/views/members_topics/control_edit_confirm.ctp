...
<?php echo $this->DisplayImage->displayControlThumbnail($data['MembersTopic']['member_topic_image']['name'], 8, 75, 150, true); ?>
<br>
...
<?php elseif($saveTmpImageResult['member_topic_image']['result_code'] == UPLOAD_NO_DATA): ?>
...
<p>
<?php echo $this->Form->create('MembersTopic', array('type' => 'file', 'action' => 'control_edit')); ?>
<?php echo $this->Formhidden->hiddenVars(); ?>
<?php echo $this->Form->submit('入力画面に戻る', array('div' => false, 'id' => 'indexButton')); ?>
<?php echo $this->Form->end(); ?>
&nbsp;
<?php echo $this->Form->create('MembersTopic', array('type' => 'file', 'action' => 'control_edit_complete')); ?>
<?php echo $this->Formhidden->hiddenVars(); ?>
